...
def this_main_zy_diag(project,diag):
    ...
    a.主诊医师编码, a.主诊医师姓名,a.入院日期, a.出院日期, a.住院天数,a.医疗总发生费用, 人员类型,
    a.医保申请支付金额 as 医保申请总支付金额 , a.医保实际支付费用,a.入院诊断名称||','|| a.出院诊断名称 as 诊断拼接,
    ...
    a.主诊医师编码, a.主诊医师姓名,a.入院日期, a.出院日期, a.住院天数,a.医疗总发生费用, 人员类型,
    a.医保申请支付金额, a.医保实际支付费用,a.入院科室名称,a.入院诊断名称||','|| a.出院诊断名称 ,
    b.费用类别, b.执行科室名称,b.医保项目编码, b.医保项目名称, b.医院项目编码, b.医院项目名称, 规格,剂型,b.单价"""
