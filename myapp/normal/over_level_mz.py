...
def this_main_mz_level(project,diag):
    ...
    """
    input_head2 = """
    GROUP BY a.医疗机构编码, a.医疗机构名称, a.医院级别, a.结算单据号, a.结算类别, a.结算日期, a.险种类型, a.就医类型, a.异地标志, a.人员类别, b.退费标识
    , a.个人编码或患者社保卡号, a.患者姓名, a.患者身份证号, a.患者性别, a.患者出生日期, a.患者年龄, a.主诊医师编码
    , substr(REGEXP_REPLACE(项目使用时间, '[^0-9 ]+', ''),0,8), a.主诊医师名称, a.科室编码, a.科室名称, a.诊断编码, a.诊断名称, b.医保项目编码, b.医保项目名称
    , b.医院项目编码, b.医院项目名称, b.费用类别, b.规格, b.剂型, b.最小包装单位, b.用药天数, b.单价
    """
    # 打印结果
    if diag == '':
